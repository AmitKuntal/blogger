  ...
  return (
    <div className="w-full flex flex-row flex-wrap justify-center mainbackgroundcolor">
        <div className="font-bold w-full container flex items-center justify-around p-4 h-full sm:text-md sm:pl-2 md:pl-2 lg:pl-8">         
            <div className="w-full md:w-3/5 flex flex-row bg-green justify-between">
                <div className="flex flex-col items-start">
                    ...
                    <div className="flex flex-row mt-4 w-full item-center justify-between">
                        ...
                        <input type="button" value="Cancel"  className="p-2 pl-4 pr-4 rounded bg-white border-gray-500 border-solid border-2 text-gray-500"/>
                    </div>
                </div>
                <div className="flex flex-col jutify-center items-center">
                    <img src={props.img} className="h-12 w-12 sm:h-20 sm:w-20 md:h-24 md:w-24 rounded-full inline-flex items-center"> 
                    </img>
                    <button onClick={() => fileInputRef.current.click()}><FontAwesomeIcon icon={faCamera} size="md" /> </button>
                    <input
                        ref={fileInputRef}
                        type="file"
                        hidden
