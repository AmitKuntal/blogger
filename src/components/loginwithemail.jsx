...
function LoginWithEmail(props) {
  ...
  return (
            <div className="p-8 flex flex-col text-center items-center">
                 ...
                 <input className=" border-b border-b-4 w-full py-2 px-3 text-gray-700 text-center leading-tight focus:outline-none focus:shadow-outline" value={password?password:""} id="password" type="password" onChange= {handelPasswordChange}/>
                 <button
                 className=" bg-teal-500 mt-3 pr-6 inline-block text-sm px-4 py-2 leading-none border rounded text-white border-black "
                 type="button"
                 style={{ transition: "all .15s ease" }}
                 onClick={props.changeAuthenticate}
                 >
                     Login
                 </button>
               </div>)
                 :(<div className="mb-4">
                    ...
                    <input className=" border-b border-b-4 w-full py-2 px-3 text-gray-700 text-center leading-tight focus:outline-none focus:shadow-outline" value={email?email:""} id="username" type="text" onChange= {handelEmailChange}/>
                    <button
                    className=" bg-teal-500 mt-3 pr-6 inline-block text-sm px-4 py-2 leading-none border rounded text-white border-black "
                    type="button"
                    style={{ transition: "all .15s ease" }}
